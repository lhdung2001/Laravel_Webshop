                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="prod-color-tr">
                                            ...
                                            <td>
                                                <button type="button" value="{{ $prodColor->id }}" onclick="return confirm('Are you sure, you want to delete this data?')" class="deleteProductColorBtn btn btn-danger btn-sm text-white"> Delete</button>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
