                        ...
                        <hr>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" wire:model.defer="fullname" name="fullname" class="form-control" placeholder="Enter Full Name" />
                                    @error('fullname')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" wire:model.defer="phone" name="phone" class="form-control" placeholder="Enter Phone Number" />
                                    @error('phone')
                                        <small class="text-danger">{{ $message }} </small>
                                    @enderror
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="email" wire:model.defer="email" name="email" class="form-control" placeholder="Enter Email Address" />
                                    @error('email')
                                        <small class="text-danger">{{ $message }} </small>
                                    @enderror
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" wire:model.defer="pincode" name="pincode" class="form-control" placeholder="Enter Pin-code" />
                                    @error('pincode')
                                        <small class="text-danger">{{ $message }} </small>
                                    @enderror
                                </div>
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="address" wire:model.defer="address" class="form-control" rows="2"></textarea>
                                    @error('address')
                                    <small class="text-danger">{{ $message }} </small>
                                @enderror
                                </div>
